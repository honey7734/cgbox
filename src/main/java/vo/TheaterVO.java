...
public class TheaterVO {
	...
	public int getMtheater_no() {
		return mtheater_no;
	}
	public void setMtheater_no(int mtheater_no) {
		this.mtheater_no = mtheater_no;
	}
	public int getTheater_name() {
		return theater_name;
	}
	...
	public String toString() {
		return "TheaterVO [theater_no=" + theater_no + ", theater_seat=" + theater_seat + ", theater_kind="
				+ theater_kind + ", theater_price=" + theater_price + ", mtheater_no=" + mtheater_no + ", theater_name="
				+ theater_name + "]";
	}
}
